...
- 2026-08-22T07:26:00.518Z — Wired the volatility start tile's exchange selection through the UI and quick-start request, and verified TypeScript plus production build; Bitrue crypto-grid execution remains intentionally blocked because its separate executor is not implemented.
- 2026-08-22T17:26:38.816Z — Fixed hedge trailing stop placement by sending the surviving position quantity (`slQty`) to Bitunix; TypeScript check and production build passed, and service restart was queued.
